...
/**
 * ekron functions and definitions
 *
...
if (! function_exists('ekron_setup')) :
	...
	function ekron_setup()
	{
		 ...
		 * If you're building a theme based on ekron, use a find and replace
...
function include_custom_php_files()
{
	$custom_folder = get_template_directory() . '/app/';
	var_dump(glob("app/*/*.{php}", \GLOB_BRACE));
...
/** Customizer Settings */
require_once get_template_directory() . '/app/Customizer.php';

/** ACF setup Test */
require_once get_template_directory() . '/app/ACFFields.php';
